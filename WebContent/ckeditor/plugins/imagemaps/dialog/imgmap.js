...
//	x = (this.isMSIE) ? (window.event.x + this.pic_container.scrollLeft - this.pic.offsetLeft) : (e.clientX - pos.x);
//	y = (this.isMSIE) ? (window.event.y + this.pic_container.scrollTop - this.pic.offsetTop)  : (e.clientY - pos.y);
	x = (this.isMSIE) ? (window.event.x + this.pic_container.scrollLeft - this.pic.offsetLeft) : (e.clientX - pos.x);
	y = (this.isMSIE) ? (window.event.y + this.pic_container.scrollTop - this.pic.offsetTop)  : (e.clientY - pos.y);
...
//	var y = (this.isMSIE) ? (window.event.y - this.pic.offsetTop)  : (e.clientY - pos.y);
	var x = (this.isMSIE) ? (window.event.x + this.pic_container.scrollLeft - this.pic.offsetLeft) : (e.clientX - pos.x);
	var y = (this.isMSIE) ? (window.event.y + this.pic_container.scrollTop - this.pic.offsetTop)  : (e.clientY - pos.y);
